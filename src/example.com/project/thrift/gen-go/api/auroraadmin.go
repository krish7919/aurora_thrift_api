...
func (p *AuroraAdminClient) recvForceTaskState() (value *Response, err error) {
	...
	if mTypeId == thrift.EXCEPTION {
		error372 := thrift.NewTApplicationException(thrift.UNKNOWN_APPLICATION_EXCEPTION, "Unknown Exception")
		var error373 error
...
func (p *AuroraAdminClient) recvListBackups() (value *Response, err error) {
	...
	if mTypeId == thrift.EXCEPTION {
		error376 := thrift.NewTApplicationException(thrift.UNKNOWN_APPLICATION_EXCEPTION, "Unknown Exception")
		var error377 error
...
func (p *AuroraAdminClient) recvQueryRecovery() (value *Response, err error) {
	...
	if mTypeId == thrift.EXCEPTION {
		error380 := thrift.NewTApplicationException(thrift.UNKNOWN_APPLICATION_EXCEPTION, "Unknown Exception")
		var error381 error
...
func (p *AuroraAdminClient) recvCommitRecovery() (value *Response, err error) {
	...
	if mTypeId == thrift.EXCEPTION {
		error384 := thrift.NewTApplicationException(thrift.UNKNOWN_APPLICATION_EXCEPTION, "Unknown Exception")
		var error385 error
...
func (p *AuroraAdminClient) recvStartMaintenance() (value *Response, err error) {
	...
	if mTypeId == thrift.EXCEPTION {
		error388 := thrift.NewTApplicationException(thrift.UNKNOWN_APPLICATION_EXCEPTION, "Unknown Exception")
		var error389 error
...
func (p *AuroraAdminClient) recvMaintenanceStatus() (value *Response, err error) {
	...
	if mTypeId == thrift.EXCEPTION {
		error392 := thrift.NewTApplicationException(thrift.UNKNOWN_APPLICATION_EXCEPTION, "Unknown Exception")
		var error393 error
...
func (p *AuroraAdminClient) recvSnapshot() (value *Response, err error) {
	...
	if mTypeId == thrift.EXCEPTION {
		error396 := thrift.NewTApplicationException(thrift.UNKNOWN_APPLICATION_EXCEPTION, "Unknown Exception")
		var error397 error
...
func NewAuroraAdminProcessor(handler AuroraAdmin) *AuroraAdminProcessor {
	self400 := &AuroraAdminProcessor{NewAuroraSchedulerManagerProcessor(handler)}
	self400.AddToProcessorMap("setQuota", &auroraAdminProcessorSetQuota{handler: handler})
	self400.AddToProcessorMap("forceTaskState", &auroraAdminProcessorForceTaskState{handler: handler})
	self400.AddToProcessorMap("performBackup", &auroraAdminProcessorPerformBackup{handler: handler})
	self400.AddToProcessorMap("listBackups", &auroraAdminProcessorListBackups{handler: handler})
	self400.AddToProcessorMap("stageRecovery", &auroraAdminProcessorStageRecovery{handler: handler})
	self400.AddToProcessorMap("queryRecovery", &auroraAdminProcessorQueryRecovery{handler: handler})
	self400.AddToProcessorMap("deleteRecoveryTasks", &auroraAdminProcessorDeleteRecoveryTasks{handler: handler})
	self400.AddToProcessorMap("commitRecovery", &auroraAdminProcessorCommitRecovery{handler: handler})
	self400.AddToProcessorMap("unloadRecovery", &auroraAdminProcessorUnloadRecovery{handler: handler})
	self400.AddToProcessorMap("startMaintenance", &auroraAdminProcessorStartMaintenance{handler: handler})
	self400.AddToProcessorMap("drainHosts", &auroraAdminProcessorDrainHosts{handler: handler})
	self400.AddToProcessorMap("maintenanceStatus", &auroraAdminProcessorMaintenanceStatus{handler: handler})
	self400.AddToProcessorMap("endMaintenance", &auroraAdminProcessorEndMaintenance{handler: handler})
	self400.AddToProcessorMap("snapshot", &auroraAdminProcessorSnapshot{handler: handler})
	self400.AddToProcessorMap("rewriteConfigs", &auroraAdminProcessorRewriteConfigs{handler: handler})
	return self400
}
