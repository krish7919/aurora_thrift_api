...
type AuroraSchedulerManager interface {
	...
	//  - Description
	//  - Lock
	CreateJob(description *JobConfiguration, lock *Lock) (r *Response, err error)
	...
	//  - Description
	//  - Lock
	ScheduleCronJob(description *JobConfiguration, lock *Lock) (r *Response, err error)
	...
	//  - Job
	//  - Lock
	DescheduleCronJob(job *JobKey, lock *Lock) (r *Response, err error)
	...
	//  - ShardIds
	//  - Lock
	RestartShards(job *JobKey, shardIds map[int32]bool, lock *Lock) (r *Response, err error)
	...
	//  - Job
	//  - Instances
	KillTasks(query *TaskQuery, lock *Lock, job *JobKey, instances map[int32]bool) (r *Response, err error)
	...
	//  - Key
	//  - Count
	AddInstances(config *AddInstancesConfig, lock *Lock, key *InstanceKey, count int32) (r *Response, err error)
	// Creates and saves a new Lock instance guarding against multiple mutating operations within the
	// context defined by LockKey.
	//
	// Parameters:
	//  - LockKey
	AcquireLock(lockKey *LockKey) (r *Response, err error)
	// Releases the lock acquired earlier in acquireLock call.
	//
	// Parameters:
	//  - Lock
	//  - Validation
	ReleaseLock(lock *Lock, validation LockValidation) (r *Response, err error)
	...
	//  - Config
	//  - Lock
	ReplaceCronTemplate(config *JobConfiguration, lock *Lock) (r *Response, err error)
...
//  - Description
//  - Lock
func (p *AuroraSchedulerManagerClient) CreateJob(description *JobConfiguration, lock *Lock) (r *Response, err error) {
	if err = p.sendCreateJob(description, lock); err != nil {
		return
	}
	return p.recvCreateJob()
}

func (p *AuroraSchedulerManagerClient) sendCreateJob(description *JobConfiguration, lock *Lock) (err error) {
...
//  - Description
//  - Lock
func (p *AuroraSchedulerManagerClient) ScheduleCronJob(description *JobConfiguration, lock *Lock) (r *Response, err error) {
	if err = p.sendScheduleCronJob(description, lock); err != nil {
		return
	}
	return p.recvScheduleCronJob()
}

func (p *AuroraSchedulerManagerClient) sendScheduleCronJob(description *JobConfiguration, lock *Lock) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
//  - Job
//  - Lock
func (p *AuroraSchedulerManagerClient) DescheduleCronJob(job *JobKey, lock *Lock) (r *Response, err error) {
	if err = p.sendDescheduleCronJob(job, lock); err != nil {
		return
	}
	return p.recvDescheduleCronJob()
}

func (p *AuroraSchedulerManagerClient) sendDescheduleCronJob(job *JobKey, lock *Lock) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
//  - ShardIds
//  - Lock
func (p *AuroraSchedulerManagerClient) RestartShards(job *JobKey, shardIds map[int32]bool, lock *Lock) (r *Response, err error) {
	if err = p.sendRestartShards(job, shardIds, lock); err != nil {
		return
	}
	return p.recvRestartShards()
}

func (p *AuroraSchedulerManagerClient) sendRestartShards(job *JobKey, shardIds map[int32]bool, lock *Lock) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
//  - Job
//  - Instances
func (p *AuroraSchedulerManagerClient) KillTasks(query *TaskQuery, lock *Lock, job *JobKey, instances map[int32]bool) (r *Response, err error) {
	if err = p.sendKillTasks(query, lock, job, instances); err != nil {
		return
	}
	return p.recvKillTasks()
}

func (p *AuroraSchedulerManagerClient) sendKillTasks(query *TaskQuery, lock *Lock, job *JobKey, instances map[int32]bool) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
//  - Key
//  - Count
func (p *AuroraSchedulerManagerClient) AddInstances(config *AddInstancesConfig, lock *Lock, key *InstanceKey, count int32) (r *Response, err error) {
	if err = p.sendAddInstances(config, lock, key, count); err != nil {
		return
	}
	return p.recvAddInstances()
}

func (p *AuroraSchedulerManagerClient) sendAddInstances(config *AddInstancesConfig, lock *Lock, key *InstanceKey, count int32) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
// Parameters:
//  - LockKey
func (p *AuroraSchedulerManagerClient) AcquireLock(lockKey *LockKey) (r *Response, err error) {
	if err = p.sendAcquireLock(lockKey); err != nil {
		return
	}
	return p.recvAcquireLock()
}

func (p *AuroraSchedulerManagerClient) sendAcquireLock(lockKey *LockKey) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
	...
	p.SeqId++
	if err = oprot.WriteMessageBegin("acquireLock", thrift.CALL, p.SeqId); err != nil {
		return
	}
	args := AuroraSchedulerManagerAcquireLockArgs{
		LockKey: lockKey,
	}
	if err = args.Write(oprot); err != nil {
		return
...
func (p *AuroraSchedulerManagerClient) recvAcquireLock() (value *Response, err error) {
	iprot := p.InputProtocol
	if iprot == nil {
		iprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.InputProtocol = iprot
	...
	if method != "acquireLock" {
		err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "acquireLock failed: wrong method name")
		return
	}
	if p.SeqId != seqId {
		err = thrift.NewTApplicationException(thrift.BAD_SEQUENCE_ID, "acquireLock failed: out of sequence response")
		return
	}
	if mTypeId == thrift.EXCEPTION {
	...
	if mTypeId != thrift.REPLY {
		err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "acquireLock failed: invalid message type")
		return
	}
	result := AuroraSchedulerManagerAcquireLockResult{}
	if err = result.Read(iprot); err != nil {
		return
	}
	if err = iprot.ReadMessageEnd(); err != nil {
...
//  - Lock
//  - Validation
func (p *AuroraSchedulerManagerClient) ReleaseLock(lock *Lock, validation LockValidation) (r *Response, err error) {
	if err = p.sendReleaseLock(lock, validation); err != nil {
		return
	}
	return p.recvReleaseLock()
}

func (p *AuroraSchedulerManagerClient) sendReleaseLock(lock *Lock, validation LockValidation) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
	...
	p.SeqId++
	if err = oprot.WriteMessageBegin("releaseLock", thrift.CALL, p.SeqId); err != nil {
		return
	}
	args := AuroraSchedulerManagerReleaseLockArgs{
		Lock:       lock,
...
func (p *AuroraSchedulerManagerClient) recvReleaseLock() (value *Response, err error) {
	iprot := p.InputProtocol
	if iprot == nil {
		iprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.InputProtocol = iprot
	...
	if method != "releaseLock" {
		err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "releaseLock failed: wrong method name")
		return
	}
	if p.SeqId != seqId {
		err = thrift.NewTApplicationException(thrift.BAD_SEQUENCE_ID, "releaseLock failed: out of sequence response")
		return
	}
	if mTypeId == thrift.EXCEPTION {
	...
	if mTypeId != thrift.REPLY {
		err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "releaseLock failed: invalid message type")
		return
	}
	result := AuroraSchedulerManagerReleaseLockResult{}
	if err = result.Read(iprot); err != nil {
		return
	}
	if err = iprot.ReadMessageEnd(); err != nil {
...
//  - Config
//  - Lock
func (p *AuroraSchedulerManagerClient) ReplaceCronTemplate(config *JobConfiguration, lock *Lock) (r *Response, err error) {
	if err = p.sendReplaceCronTemplate(config, lock); err != nil {
		return
	}
	return p.recvReplaceCronTemplate()
}

func (p *AuroraSchedulerManagerClient) sendReplaceCronTemplate(config *JobConfiguration, lock *Lock) (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
...
func NewAuroraSchedulerManagerProcessor(handler AuroraSchedulerManager) *AuroraSchedulerManagerProcessor {
	...
	self155.AddToProcessorMap("acquireLock", &auroraSchedulerManagerProcessorAcquireLock{handler: handler})
	self155.AddToProcessorMap("releaseLock", &auroraSchedulerManagerProcessorReleaseLock{handler: handler})
...
func (p *auroraSchedulerManagerProcessorCreateJob) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.CreateJob(args.Description, args.Lock); err2 != nil {
...
func (p *auroraSchedulerManagerProcessorScheduleCronJob) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.ScheduleCronJob(args.Description, args.Lock); err2 != nil {
...
func (p *auroraSchedulerManagerProcessorDescheduleCronJob) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.DescheduleCronJob(args.Job, args.Lock); err2 != nil {
...
func (p *auroraSchedulerManagerProcessorRestartShards) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.RestartShards(args.Job, args.ShardIds, args.Lock); err2 != nil {
...
func (p *auroraSchedulerManagerProcessorKillTasks) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.KillTasks(args.Query, args.Lock, args.Job, args.Instances); err2 != nil {
...
func (p *auroraSchedulerManagerProcessorAddInstances) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.AddInstances(args.Config, args.Lock, args.Key, args.Count); err2 != nil {
...
type auroraSchedulerManagerProcessorAcquireLock struct {
	handler AuroraSchedulerManager
}

func (p *auroraSchedulerManagerProcessorAcquireLock) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := AuroraSchedulerManagerAcquireLockArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("acquireLock", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush()
		return false, err
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.AcquireLock(args.LockKey); err2 != nil {
	...
	if err2 = oprot.WriteMessageBegin("acquireLock", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type auroraSchedulerManagerProcessorReleaseLock struct {
	handler AuroraSchedulerManager
}

func (p *auroraSchedulerManagerProcessorReleaseLock) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := AuroraSchedulerManagerReleaseLockArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("releaseLock", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush()
		return false, err
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.ReleaseLock(args.Lock, args.Validation); err2 != nil {
	...
	if err2 = oprot.WriteMessageBegin("releaseLock", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
func (p *auroraSchedulerManagerProcessorReplaceCronTemplate) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.ReplaceCronTemplate(args.Config, args.Lock); err2 != nil {
...
type AuroraSchedulerManagerCreateJobArgs struct {
	...
	// unused field # 2
	Lock *Lock `thrift:"lock,3" json:"lock"`
}
...
var AuroraSchedulerManagerCreateJobArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerCreateJobArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerCreateJobArgs_Lock_DEFAULT
	}
	return p.Lock
}
...
func (p *AuroraSchedulerManagerCreateJobArgs) IsSetLock() bool {
	return p.Lock != nil
}
...
func (p *AuroraSchedulerManagerCreateJobArgs) readField3(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
...
func (p *AuroraSchedulerManagerCreateJobArgs) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lock", thrift.STRUCT, 3); err != nil {
...
var AuroraSchedulerManagerScheduleCronJobArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerScheduleCronJobArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerScheduleCronJobArgs_Lock_DEFAULT
	}
	return p.Lock
}
...
func (p *AuroraSchedulerManagerScheduleCronJobArgs) IsSetLock() bool {
	return p.Lock != nil
}
...
func (p *AuroraSchedulerManagerScheduleCronJobArgs) readField3(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
	if err := p.Lock.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Lock), err)
	}
...
func (p *AuroraSchedulerManagerScheduleCronJobArgs) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lock", thrift.STRUCT, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:lock: ", p), err)
	}
	if err := p.Lock.Write(oprot); err != nil {
...
var AuroraSchedulerManagerDescheduleCronJobArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerDescheduleCronJobArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerDescheduleCronJobArgs_Lock_DEFAULT
	}
	return p.Lock
}
...
func (p *AuroraSchedulerManagerDescheduleCronJobArgs) IsSetLock() bool {
	return p.Lock != nil
}
...
func (p *AuroraSchedulerManagerDescheduleCronJobArgs) readField3(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
	if err := p.Lock.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Lock), err)
	}
...
func (p *AuroraSchedulerManagerDescheduleCronJobArgs) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lock", thrift.STRUCT, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:lock: ", p), err)
	}
	if err := p.Lock.Write(oprot); err != nil {
...
type AuroraSchedulerManagerRestartShardsArgs struct {
	...
	Lock *Lock   `thrift:"lock,6" json:"lock"`
}
...
var AuroraSchedulerManagerRestartShardsArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerRestartShardsArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerRestartShardsArgs_Lock_DEFAULT
	}
	return p.Lock
}
...
func (p *AuroraSchedulerManagerRestartShardsArgs) IsSetLock() bool {
	return p.Lock != nil
}
...
func (p *AuroraSchedulerManagerRestartShardsArgs) readField6(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
	if err := p.Lock.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Lock), err)
	}
...
func (p *AuroraSchedulerManagerRestartShardsArgs) writeField6(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lock", thrift.STRUCT, 6); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 6:lock: ", p), err)
	}
	if err := p.Lock.Write(oprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.Lock), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 6:lock: ", p), err)
	}
	return err
}
...
var AuroraSchedulerManagerKillTasksArgs_Query_DEFAULT *TaskQuery

func (p *AuroraSchedulerManagerKillTasksArgs) GetQuery() *TaskQuery {
	if !p.IsSetQuery() {
		return AuroraSchedulerManagerKillTasksArgs_Query_DEFAULT
	}
	return p.Query
}

var AuroraSchedulerManagerKillTasksArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerKillTasksArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerKillTasksArgs_Lock_DEFAULT
	}
	return p.Lock
}
...
func (p *AuroraSchedulerManagerKillTasksArgs) IsSetQuery() bool {
	return p.Query != nil
}

func (p *AuroraSchedulerManagerKillTasksArgs) IsSetLock() bool {
	return p.Lock != nil
}
...
func (p *AuroraSchedulerManagerKillTasksArgs) readField1(iprot thrift.TProtocol) error {
	p.Query = &TaskQuery{}
...
func (p *AuroraSchedulerManagerKillTasksArgs) readField3(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
	if err := p.Lock.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Lock), err)
	}
...
func (p *AuroraSchedulerManagerKillTasksArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *AuroraSchedulerManagerKillTasksArgs) writeField3(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lock", thrift.STRUCT, 3); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 3:lock: ", p), err)
	}
	if err := p.Lock.Write(oprot); err != nil {
...
type AuroraSchedulerManagerAddInstancesArgs struct {
	Config *AddInstancesConfig `thrift:"config,1" json:"config"`
	Lock   *Lock               `thrift:"lock,2" json:"lock"`
...
var AuroraSchedulerManagerAddInstancesArgs_Config_DEFAULT *AddInstancesConfig

func (p *AuroraSchedulerManagerAddInstancesArgs) GetConfig() *AddInstancesConfig {
	if !p.IsSetConfig() {
		return AuroraSchedulerManagerAddInstancesArgs_Config_DEFAULT
	}
	return p.Config
}

var AuroraSchedulerManagerAddInstancesArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerAddInstancesArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerAddInstancesArgs_Lock_DEFAULT
	}
	return p.Lock
}
...
func (p *AuroraSchedulerManagerAddInstancesArgs) IsSetConfig() bool {
	return p.Config != nil
}

func (p *AuroraSchedulerManagerAddInstancesArgs) IsSetLock() bool {
	return p.Lock != nil
}
...
func (p *AuroraSchedulerManagerAddInstancesArgs) readField1(iprot thrift.TProtocol) error {
	p.Config = &AddInstancesConfig{}
...
func (p *AuroraSchedulerManagerAddInstancesArgs) readField2(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
	if err := p.Lock.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Lock), err)
	}
...
func (p *AuroraSchedulerManagerAddInstancesArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *AuroraSchedulerManagerAddInstancesArgs) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lock", thrift.STRUCT, 2); err != nil {
...
// Attributes:
//  - LockKey
type AuroraSchedulerManagerAcquireLockArgs struct {
	LockKey *LockKey `thrift:"lockKey,1" json:"lockKey"`
}

func NewAuroraSchedulerManagerAcquireLockArgs() *AuroraSchedulerManagerAcquireLockArgs {
	return &AuroraSchedulerManagerAcquireLockArgs{}
}

var AuroraSchedulerManagerAcquireLockArgs_LockKey_DEFAULT *LockKey

func (p *AuroraSchedulerManagerAcquireLockArgs) GetLockKey() *LockKey {
	if !p.IsSetLockKey() {
		return AuroraSchedulerManagerAcquireLockArgs_LockKey_DEFAULT
	}
	return p.LockKey
}
func (p *AuroraSchedulerManagerAcquireLockArgs) IsSetLockKey() bool {
	return p.LockKey != nil
}

func (p *AuroraSchedulerManagerAcquireLockArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *AuroraSchedulerManagerAcquireLockArgs) readField1(iprot thrift.TProtocol) error {
	p.LockKey = &LockKey{}
	if err := p.LockKey.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.LockKey), err)
	}
	return nil
}

func (p *AuroraSchedulerManagerAcquireLockArgs) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("acquireLock_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if err := p.writeField1(oprot); err != nil {
		return err
...
func (p *AuroraSchedulerManagerAcquireLockArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lockKey", thrift.STRUCT, 1); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:lockKey: ", p), err)
	}
	if err := p.LockKey.Write(oprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error writing struct: ", p.LockKey), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 1:lockKey: ", p), err)
	}
	return err
}

func (p *AuroraSchedulerManagerAcquireLockArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AuroraSchedulerManagerAcquireLockArgs(%+v)", *p)
}

// Attributes:
//  - Success
type AuroraSchedulerManagerAcquireLockResult struct {
	Success *Response `thrift:"success,0" json:"success,omitempty"`
}

func NewAuroraSchedulerManagerAcquireLockResult() *AuroraSchedulerManagerAcquireLockResult {
	return &AuroraSchedulerManagerAcquireLockResult{}
}

var AuroraSchedulerManagerAcquireLockResult_Success_DEFAULT *Response

func (p *AuroraSchedulerManagerAcquireLockResult) GetSuccess() *Response {
	if !p.IsSetSuccess() {
		return AuroraSchedulerManagerAcquireLockResult_Success_DEFAULT
	}
	return p.Success
}
func (p *AuroraSchedulerManagerAcquireLockResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *AuroraSchedulerManagerAcquireLockResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *AuroraSchedulerManagerAcquireLockResult) readField0(iprot thrift.TProtocol) error {
	p.Success = &Response{}
	if err := p.Success.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
	}
...
func (p *AuroraSchedulerManagerAcquireLockResult) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("acquireLock_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if err := p.writeField0(oprot); err != nil {
		return err
...
func (p *AuroraSchedulerManagerAcquireLockResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *AuroraSchedulerManagerAcquireLockResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AuroraSchedulerManagerAcquireLockResult(%+v)", *p)
}

// Attributes:
//  - Lock
//  - Validation
type AuroraSchedulerManagerReleaseLockArgs struct {
	Lock       *Lock          `thrift:"lock,1" json:"lock"`
	Validation LockValidation `thrift:"validation,2" json:"validation"`
}

func NewAuroraSchedulerManagerReleaseLockArgs() *AuroraSchedulerManagerReleaseLockArgs {
	return &AuroraSchedulerManagerReleaseLockArgs{}
}

var AuroraSchedulerManagerReleaseLockArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerReleaseLockArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerReleaseLockArgs_Lock_DEFAULT
	}
	return p.Lock
}

func (p *AuroraSchedulerManagerReleaseLockArgs) GetValidation() LockValidation {
	return p.Validation
}
func (p *AuroraSchedulerManagerReleaseLockArgs) IsSetLock() bool {
	return p.Lock != nil
}

func (p *AuroraSchedulerManagerReleaseLockArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *AuroraSchedulerManagerReleaseLockArgs) readField1(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
	if err := p.Lock.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Lock), err)
	}
...
func (p *AuroraSchedulerManagerReleaseLockArgs) readField2(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadI32(); err != nil {
		return thrift.PrependError("error reading field 2: ", err)
	} else {
		temp := LockValidation(v)
		p.Validation = temp
	}
	return nil
}

func (p *AuroraSchedulerManagerReleaseLockArgs) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("releaseLock_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if err := p.writeField1(oprot); err != nil {
		return err
...
func (p *AuroraSchedulerManagerReleaseLockArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *AuroraSchedulerManagerReleaseLockArgs) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("validation", thrift.I32, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:validation: ", p), err)
	}
	if err := oprot.WriteI32(int32(p.Validation)); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T.validation (2) field write error: ", p), err)
	}
	if err := oprot.WriteFieldEnd(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field end error 2:validation: ", p), err)
	}
	return err
}

func (p *AuroraSchedulerManagerReleaseLockArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AuroraSchedulerManagerReleaseLockArgs(%+v)", *p)
}

// Attributes:
//  - Success
type AuroraSchedulerManagerReleaseLockResult struct {
	Success *Response `thrift:"success,0" json:"success,omitempty"`
}

func NewAuroraSchedulerManagerReleaseLockResult() *AuroraSchedulerManagerReleaseLockResult {
	return &AuroraSchedulerManagerReleaseLockResult{}
}

var AuroraSchedulerManagerReleaseLockResult_Success_DEFAULT *Response

func (p *AuroraSchedulerManagerReleaseLockResult) GetSuccess() *Response {
	if !p.IsSetSuccess() {
		return AuroraSchedulerManagerReleaseLockResult_Success_DEFAULT
	}
	return p.Success
}
func (p *AuroraSchedulerManagerReleaseLockResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *AuroraSchedulerManagerReleaseLockResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *AuroraSchedulerManagerReleaseLockResult) readField0(iprot thrift.TProtocol) error {
	p.Success = &Response{}
	if err := p.Success.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
	}
...
func (p *AuroraSchedulerManagerReleaseLockResult) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("releaseLock_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if err := p.writeField0(oprot); err != nil {
		return err
...
func (p *AuroraSchedulerManagerReleaseLockResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *AuroraSchedulerManagerReleaseLockResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("AuroraSchedulerManagerReleaseLockResult(%+v)", *p)
}
...
var AuroraSchedulerManagerReplaceCronTemplateArgs_Lock_DEFAULT *Lock

func (p *AuroraSchedulerManagerReplaceCronTemplateArgs) GetLock() *Lock {
	if !p.IsSetLock() {
		return AuroraSchedulerManagerReplaceCronTemplateArgs_Lock_DEFAULT
	}
	return p.Lock
}
...
func (p *AuroraSchedulerManagerReplaceCronTemplateArgs) IsSetLock() bool {
	return p.Lock != nil
}
...
func (p *AuroraSchedulerManagerReplaceCronTemplateArgs) readField2(iprot thrift.TProtocol) error {
	p.Lock = &Lock{}
	if err := p.Lock.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Lock), err)
	}
...
func (p *AuroraSchedulerManagerReplaceCronTemplateArgs) writeField2(oprot thrift.TProtocol) (err error) {
	if err := oprot.WriteFieldBegin("lock", thrift.STRUCT, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:lock: ", p), err)
	}
	if err := p.Lock.Write(oprot); err != nil {
