...
// Returns all stored context specific resource/operation locks.
func (p *ReadOnlySchedulerClient) GetLocks() (r *Response, err error) {
	if err = p.sendGetLocks(); err != nil {
		return
	}
	return p.recvGetLocks()
}

func (p *ReadOnlySchedulerClient) sendGetLocks() (err error) {
	oprot := p.OutputProtocol
	if oprot == nil {
		oprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.OutputProtocol = oprot
	...
	p.SeqId++
	if err = oprot.WriteMessageBegin("getLocks", thrift.CALL, p.SeqId); err != nil {
		return
	}
	args := ReadOnlySchedulerGetLocksArgs{}
	if err = args.Write(oprot); err != nil {
		return
	}
	if err = oprot.WriteMessageEnd(); err != nil {
...
func (p *ReadOnlySchedulerClient) recvGetLocks() (value *Response, err error) {
	iprot := p.InputProtocol
	if iprot == nil {
		iprot = p.ProtocolFactory.GetProtocol(p.Transport)
		p.InputProtocol = iprot
	...
	if method != "getLocks" {
		err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "getLocks failed: wrong method name")
		return
	}
	if p.SeqId != seqId {
		err = thrift.NewTApplicationException(thrift.BAD_SEQUENCE_ID, "getLocks failed: out of sequence response")
		return
	}
	if mTypeId == thrift.EXCEPTION {
	...
	if mTypeId != thrift.REPLY {
		err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "getLocks failed: invalid message type")
		return
	}
	result := ReadOnlySchedulerGetLocksResult{}
	if err = result.Read(iprot); err != nil {
		return
	}
	if err = iprot.ReadMessageEnd(); err != nil {
...
func NewReadOnlySchedulerProcessor(handler ReadOnlyScheduler) *ReadOnlySchedulerProcessor {
	...
	self72 := &ReadOnlySchedulerProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self72.processorMap["getRoleSummary"] = &readOnlySchedulerProcessorGetRoleSummary{handler: handler}
	self72.processorMap["getJobSummary"] = &readOnlySchedulerProcessorGetJobSummary{handler: handler}
	self72.processorMap["getTasksStatus"] = &readOnlySchedulerProcessorGetTasksStatus{handler: handler}
	self72.processorMap["getTasksWithoutConfigs"] = &readOnlySchedulerProcessorGetTasksWithoutConfigs{handler: handler}
	self72.processorMap["getPendingReason"] = &readOnlySchedulerProcessorGetPendingReason{handler: handler}
	self72.processorMap["getConfigSummary"] = &readOnlySchedulerProcessorGetConfigSummary{handler: handler}
	self72.processorMap["getJobs"] = &readOnlySchedulerProcessorGetJobs{handler: handler}
	self72.processorMap["getQuota"] = &readOnlySchedulerProcessorGetQuota{handler: handler}
	self72.processorMap["populateJobConfig"] = &readOnlySchedulerProcessorPopulateJobConfig{handler: handler}
	self72.processorMap["getLocks"] = &readOnlySchedulerProcessorGetLocks{handler: handler}
	self72.processorMap["getJobUpdateSummaries"] = &readOnlySchedulerProcessorGetJobUpdateSummaries{handler: handler}
	self72.processorMap["getJobUpdateDetails"] = &readOnlySchedulerProcessorGetJobUpdateDetails{handler: handler}
	self72.processorMap["getJobUpdateDiff"] = &readOnlySchedulerProcessorGetJobUpdateDiff{handler: handler}
	return self72
}
...
type readOnlySchedulerProcessorGetLocks struct {
	handler ReadOnlyScheduler
}

func (p *readOnlySchedulerProcessorGetLocks) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := ReadOnlySchedulerGetLocksArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("getLocks", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush()
		return false, err
	...
	var retval *Response
	var err2 error
	if retval, err2 = p.handler.GetLocks(); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing getLocks: "+err2.Error())
		oprot.WriteMessageBegin("getLocks", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush()
	...
	if err2 = oprot.WriteMessageBegin("getLocks", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type ReadOnlySchedulerGetLocksArgs struct {
}

func NewReadOnlySchedulerGetLocksArgs() *ReadOnlySchedulerGetLocksArgs {
	return &ReadOnlySchedulerGetLocksArgs{}
}

func (p *ReadOnlySchedulerGetLocksArgs) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ReadOnlySchedulerGetLocksArgs) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("getLocks_args"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if err := oprot.WriteFieldStop(); err != nil {
		return thrift.PrependError("write field stop error: ", err)
...
func (p *ReadOnlySchedulerGetLocksArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ReadOnlySchedulerGetLocksArgs(%+v)", *p)
}

// Attributes:
//  - Success
type ReadOnlySchedulerGetLocksResult struct {
	Success *Response `thrift:"success,0" json:"success,omitempty"`
}

func NewReadOnlySchedulerGetLocksResult() *ReadOnlySchedulerGetLocksResult {
	return &ReadOnlySchedulerGetLocksResult{}
}

var ReadOnlySchedulerGetLocksResult_Success_DEFAULT *Response

func (p *ReadOnlySchedulerGetLocksResult) GetSuccess() *Response {
	if !p.IsSetSuccess() {
		return ReadOnlySchedulerGetLocksResult_Success_DEFAULT
	}
	return p.Success
}
func (p *ReadOnlySchedulerGetLocksResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *ReadOnlySchedulerGetLocksResult) Read(iprot thrift.TProtocol) error {
	if _, err := iprot.ReadStructBegin(); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
	}
...
func (p *ReadOnlySchedulerGetLocksResult) readField0(iprot thrift.TProtocol) error {
	p.Success = &Response{}
	if err := p.Success.Read(iprot); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
	}
...
func (p *ReadOnlySchedulerGetLocksResult) Write(oprot thrift.TProtocol) error {
	if err := oprot.WriteStructBegin("getLocks_result"); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err)
	}
	if err := p.writeField0(oprot); err != nil {
		return err
...
func (p *ReadOnlySchedulerGetLocksResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err)
		}
...
func (p *ReadOnlySchedulerGetLocksResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("ReadOnlySchedulerGetLocksResult(%+v)", *p)
}
